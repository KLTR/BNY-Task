...
describe('OrderAddComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      providers: [
        ...
        {provide: GrowlerService, useClass: GrowlerServiceStub},
        {provide: TrackByService, useClass: TrackByServiceStub},
      ],
      imports: [
        SharedModule,
        OrdersRoutingModule,
  ...
  // Test that inputs are shown when customer is selected
  it('product name input and item cost inputs should be null', () => {
    const prodNameInput = fixture.debugElement.query(By.css('.prodName'));
    const itemCostInput = fixture.debugElement.query(By.css('.itemCost'));

    expect(prodNameInput && itemCostInput).toBeNull();
  });
});
...
class GrowlerServiceStub {

}

class TrackByServiceStub {
